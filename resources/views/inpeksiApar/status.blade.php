                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <a href="/apar/inspeksi/{{ $aparinspeksi->id }}/inputInpeksiApar" class="btn btn-dark btn-sm my-2 p-2">Belum Inspeksi </a>
                                    @else
                                    <button type="button" class="btn btn-info btn-sm my-2 lihatHasil" href="#" data-toggle="modal" data-target="#modalHasil" data-id="{{ $dataapar->id }}"> Periksa
                                        Inspeksi </button>
                                    @endif
                                </td>
                            </tr>
